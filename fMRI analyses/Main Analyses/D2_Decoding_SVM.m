...
cfg.decoding.method = 'classification'; % Define SVR as a method
cfg.decoding.train.classification.model_parameters = '-s 0 -t 0 -c 1 -b 0 -q'; % SVM Parameters

% OUTPUTS SPECIFICATION
cfg.results.output = {'accuracy_minus_chance'}; % accuracy_minus_chance is used for the second level
