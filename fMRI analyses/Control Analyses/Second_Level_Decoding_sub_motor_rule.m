...
%% showing above chance decoding accuracies for High vs Low, subsampled for motor responses and task rules
clc; clear;
...
GLM_name = 'Decoding_subsampling_motor_rule';
radius = 4;
...
for sj = 1:length(SJs)
    ...
    sj_dir =  fullfile(data_dir, SJs{sj}, 'dec_subsampling_motor_rule');
    % select the files
