...
jobfile = {'D:\vDMTC\fMRI Analysis\Conjunction\t_test_job_SVR.m'};
...
% =========================================================================
nrun = 1; % enter the number of runs here
jobfile = {'D:\vDMTC\fMRI Analysis\Conjunction\Estimate_job_SVR.m'};
jobs = repmat(jobfile, 1, nrun);
inputs = cell(0, nrun);
for crun = 1:nrun
end
...
matlabbatch{1}.spm.stats.con.spmmat(1)                  = ...
    {['D:\vDMTC\data\RFX\Conjunction\SVR' filesep 'SPM.mat']};
